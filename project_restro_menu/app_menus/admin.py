...
class MenuAdmin(admin.ModelAdmin):
    list_display = ("menu_title","menu_category","menu_price","menu_ingredient")
...
admin.site.site_title = "Admin Panel" # Page Sub Heading
admin.site.site_header = "Restro" # Page Header
admin.site.index_title = "MyRestro" # Page Title